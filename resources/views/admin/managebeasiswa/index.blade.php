                            ...
                            <div class="card-body small">
                                <table id="table-kk" class="table table-striped">
                                    ...
                                    @foreach($beasiswas as $beasiswa)
                                        <tr>
                                            <td>{{ $beasiswa->timeline ? $beasiswa->timeline->nama_periode: 'N/A' }}</td>
                                            <td>{{ $beasiswa->jenisbeasiswa ? $beasiswa->jenisbeasiswa->nama_jenis_beasiswa : 'N/A' }}</td>
                                            <td>{{ $beasiswa->nama_beasiswa }}</td>
                                            <td>{{$beasiswa->timeline ? $beasiswa->timeline->tanggal_mulai: 'N/A' }}</td>
                                            <td>{{$beasiswa->timeline ? $beasiswa->timeline->tanggal_selesai: 'N/A' }}</td>

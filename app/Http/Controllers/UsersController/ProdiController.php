...
class ProdiController extends Controller
{
    ...
    public function index()
    {
        ...
        $roleProdiCount = $users->count(); // Sudah difilter di atas, jadi bisa langsung dihitung.
    
        return view('.admin.manageprodi.index', compact('users', 'rolesCount', 'roleProdiCount'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.manageprodi.create', compact('roles'));
    }

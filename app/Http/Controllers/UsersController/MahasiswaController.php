...
class MahasiswaController extends Controller
{
    ...
    public function index()
    {
        ...
        $roleMahasiswaCount = $users->count(); // Sudah difilter di atas, jadi bisa langsung dihitung.
    
        return view('.admin.managemahasiswa.index', compact('users', 'rolesCount', 'roleMahasiswaCount'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.managemahasiswa.create', compact('roles'));
    }
